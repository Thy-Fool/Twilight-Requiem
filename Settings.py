...
Beast_data = {
    'Bane_of_destiny': {'Health': 100, 'Attack': 6, 'Speed': 4, 'Exp_drop': 25, 'knock_resistance': 3, 'Range': 300,
                        'Notice_range': 500, 'Cooldown': 400},
    'Worm_of_spirit': {'Health': 50, 'Attack': 17, 'Speed': 3, 'Exp_drop': 30, 'knock_resistance': 2, 'Range': 250,
                       'Notice_range': 430, 'Cooldown': 550},
    'Dark_Knight': {'Health': 110, 'Attack': 16, 'Speed': 4, 'Exp_drop': 35, 'knock_resistance': 3, 'Range': 100,
                    'Notice_range': 520, 'Cooldown': 600}}
